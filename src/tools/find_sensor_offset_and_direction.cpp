/**
 * Simple example intended to help users find the zero offset and natural
 * direction of the sensor.
 *
 * These values can further be used to avoid motor and sensor alignment
 * procedure. To use these values add them to the code:");
 ...
 * Bypassing the alignment procedure is not possible for the encoders and for
 * the current implementation of the Hall sensors. library version 1.4.2.
 *
 */
#include <SimpleFOC.h>
...
void setup()
{
    ...
    Serial.println(motor.sensor_direction == Direction::CW ? "Direction::CW"
                                                           : "Direction::CCW");

    Serial.println("To use these values add them to the code:");
    Serial.print("   motor.sensor_direction=");
    Serial.print(motor.sensor_direction == Direction::CW ? "Direction::CW"
                                                         : "Direction::CCW");
    Serial.println(";");
