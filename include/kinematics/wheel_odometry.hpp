...
class WheelOdometry
{
   private:
    ...
    std::array<EncoderChannel *, SOC_ADC_CHANNEL_NUM(ADC_UNIT)> m_channel_lookup;
   ...
   public:
     ...
     */
    esp_err_t init(const std::vector<adc_channel_t> & channels, adc_atten_t attenuation = ADC_ATTEN_DB_0);
